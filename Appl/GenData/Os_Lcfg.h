...
# define OS_START_SEC_LPTMR_0_CH_0_ISR_CODE
# include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

/**********************************************************************************************************************
 *  LPTMR_0_CH_0_ISR()
 *********************************************************************************************************************/
extern FUNC(void, OS_LPTMR_0_CH_0_ISR_CODE) Os_Isr_LPTMR_0_CH_0_ISR(void);

# define OS_STOP_SEC_LPTMR_0_CH_0_ISR_CODE
# include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
