...
/*! Dynamic alarm data: Rte_Al_TE_DLK_SWC_DLK_Runnable_100ms */
OS_LOCAL VAR(Os_AlarmType, OS_VAR_NOINIT) OsCfg_Alarm_Rte_Al_TE_DLK_SWC_DLK_Runnable_100ms_Dyn;
...
CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_CPUload_SWC_CPUload_Runnable_1s =
{
  ...
  /* .Task  = */ &OsCfg_Task_OsTask_CPUload
};
...
/*! Alarm configuration data: Rte_Al_TE_DLK_SWC_DLK_Runnable_100ms */
CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_DLK_SWC_DLK_Runnable_100ms =
{
  /* .Alarm = */
  {
    /* .Job                   = */
    {
      /* .Dyn      = */ OS_ALARM_CASTDYN_ALARM_2_JOB(OsCfg_Alarm_Rte_Al_TE_DLK_SWC_DLK_Runnable_100ms_Dyn),
      /* .Counter  = */ OS_COUNTER_CASTCONFIG_TIMERPIT_2_COUNTER(OsCfg_Counter_SystemTimer),
      /* .Callback = */ Os_AlarmActionActivateTask
    },
    /* .Autostart             = */
