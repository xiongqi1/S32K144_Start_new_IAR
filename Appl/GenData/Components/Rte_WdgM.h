...
FUNC(Std_ReturnType, RTE_CODE) Rte_Switch_WdgM_mode_WdgMSupervisedEntity_LedTask_currentMode(WdgMMode nextMode); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_Switch_mode_WdgMSupervisedEntity_LedTask_currentMode Rte_Switch_WdgM_mode_WdgMSupervisedEntity_LedTask_currentMode
