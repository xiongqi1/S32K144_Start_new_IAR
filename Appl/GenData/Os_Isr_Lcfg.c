...
/*! Dynamic ISR data: ADC0_Isr */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_ADC0_Isr_Dyn;

/*! Dynamic ISR data: CanIsr_0_BusOff */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_CanIsr_0_BusOff_Dyn;

/*! Dynamic ISR data: CanIsr_0_MB00To15 */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_CanIsr_0_MB00To15_Dyn;
...
/*! Dynamic ISR data: SPI0_Isr */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_SPI0_Isr_Dyn;
...
/*! ISR configuration data: ADC0_Isr */
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_ADC0_Isr =
{
  /* .Thread   = */
  {
  ...
  /* .HwConfig = */ &OsCfg_Hal_IntIsr_ADC0_Isr,
  /* .IsrId    = */ ADC0_Isr
};
...
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_CanIsr_0_MB00To15 =
{
  /* .Thread   = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_CanIsr_0_MB00To15,
    /* .Context               = */ &OsCfg_Hal_Context_OsCore0_Isr_Level2_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Isr_Core,
    /* .Dyn                   = */ OS_ISR_CASTDYN_ISR_2_THREAD(OsCfg_Isr_CanIsr_0_MB00To15_Dyn),
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0,
    /* .Core                  = */ &OsCfg_Core_OsCore0,
    /* .IntApiState           = */ &OsCfg_Core_OsCore0_Dyn.IntApiState,
    /* .TimeProtConfig        = */ NULL_PTR,
  ...
  /* .HwConfig = */ &OsCfg_Hal_IntIsr_CanIsr_0_MB00To15,
  /* .IsrId    = */ CanIsr_0_MB00To15
};
...
/*! ISR configuration data: SPI0_Isr */
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_SPI0_Isr =
{
  /* .Thread   = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_SPI0_Isr,
    /* .Context               = */ &OsCfg_Hal_Context_OsCore0_Isr_Level4_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Isr_Core,
    /* .Dyn                   = */ OS_ISR_CASTDYN_ISR_2_THREAD(OsCfg_Isr_SPI0_Isr_Dyn),
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0,
    /* .Core                  = */ &OsCfg_Core_OsCore0,
    /* .IntApiState           = */ &OsCfg_Core_OsCore0_Dyn.IntApiState,
    /* .TimeProtConfig        = */ NULL_PTR,
  ...
  /* .HwConfig = */ &OsCfg_Hal_IntIsr_SPI0_Isr,
  /* .IsrId    = */ SPI0_Isr
};
