 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: WdgM_Cfg.c
 *   Generation Time: 2025-03-21 02:34:38
...
#include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */ 
/* RAM section for supervisedEntity 'WdgMSupervisedEntity_LedTask' */ 
...
#include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */ 
/* Local Alive Counters for checkpoint 'WdgMCheckpoint_1' in 'WdgMSupervisedEntity_LedTask' */ 
...
/* Global Alive Counters for checkpoint 'WdgMCheckpoint_1' in supervised entity 'WdgMSupervisedEntity_LedTask' */ 
...
{
  {
    WdgMConf_WdgMSupervisedEntity_WdgMSupervisedEntity_LedTask /*  EntitySourceId  */ , 
    WdgMConf_WdgMCheckpoint_WdgMCheckpoint_1 /*  CheckpointSourceId  */ , 
    0u /*  WdgMDeadlineMin  */ , 
    1u /*  WdgMDeadlineMax  */ 
  } /*  [0]  */ 
};
...
WDGM_LOCAL CONST(WdgM_CheckPointType, WDGM_CONST) WdgMCheckPoint[WDGM_NR_OF_CHECKPOINTS] =
{
  ...
  {
    WdgMConf_WdgMCheckpoint_WdgMCheckpoint_2 /*  WdgMCheckpointId  */ , 
...
{
  {
    WdgMConf_WdgMSupervisedEntity_WdgMSupervisedEntity_LedTask /*  WdgMSupervisedEntity  */ , 
    FALSE /*  WdgMEnableEntityDeactivation  */ , 
    WdgMConf_WdgMCheckpoint_WdgMCheckpoint_1 /*  WdgMCheckpointLocInitialId  */ , 
    2u /*  NrOfCheckpoints  */ , 
    &WdgMCheckPoint[0] /*  WdgMCheckpointRef  */ , 
    WDGM_LOCAL_STATUS_OK /*  WdgMInitialStatus  */ , 
    3u /*  WdgMFailedSupervisionRefCycleTol  */ , 
    0u /*  WdgMFailedDeadlineRefCycleTol  */ , 
    0u /*  WdgMDeadlineReferenceCycle  */ , 
    10u /*  WdgMFailedProgramFlowRefCycleTol  */ , 
    12u /*  WdgMProgramFlowReferenceCycle  */ , 
...
CONST(WdgM_ConfigType, WDGM_CONST) WdgMConfig_Mode0_core0 = 
{
  ...
  5u /*  WdgMExpiredSupervisionCycleTol  */ , 
