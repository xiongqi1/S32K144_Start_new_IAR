...
(uint32)( WDOG_ENABLED_U32 |  WDOG_RESERVED_BIT13_U32 | WDOG_TRIGGER_MODE_REGULAR_U32 | WDOG_STOP_IN_HALT_U32 | WDOG_STOP_IN_DEBUG_U32 | WDOG_STOP_IN_WAIT_U32 | WDOG_INTERRUPT_DISABLED_U32 | WDOG_LPO_CLK_U32 | WDOG_TEST_MODE_DISABLED_U32 | WDOG_PRES_DISABLED_U32 | WDOG_UPDATE_ENABLED_U32 
...
(uint32)( WDOG_ENABLED_U32 |  WDOG_RESERVED_BIT13_U32 | WDOG_TRIGGER_MODE_REGULAR_U32 | WDOG_STOP_IN_HALT_U32 | WDOG_STOP_IN_DEBUG_U32 | WDOG_STOP_IN_WAIT_U32 | WDOG_INTERRUPT_ENABLED_U32 | WDOG_LPO_CLK_U32 | WDOG_TEST_MODE_DISABLED_U32 | WDOG_PRES_DISABLED_U32 | WDOG_UPDATE_ENABLED_U32 
        ), /* WDG Control and configuration */
        (uint32)0x0000fa00,  /* Time-out config */
        (uint32)0.0, /* Window config */
        (boolean)FALSE,
        (uint32)128 /* Internalwdgclocksource */
