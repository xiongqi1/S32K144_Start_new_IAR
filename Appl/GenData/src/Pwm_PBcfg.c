...
static CONST(Pwm_Ftm_ModuleConfigType, PWM_CONST) Pwm_Ftm_ModuleConfig_PB[PWM_FTM_MOD_CONFIGS_PB] =
{
    ...
    /* Ftm Module 0 */
    {
        ...
        (FTM_COMBINE_SYNCEN1_ENABLE_U32 | ((uint32) 0)),
...
CONST(Pwm_ConfigType, Pwm_CONST) Pwm_PBCfgVariantPredefined =
{
   /** @brief Number of configured Pwm channels */
    ...
    equal to total number of available channels on FTM IPV */
    {
        ...
        (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)0, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255, (Pwm_ChannelType)255,
