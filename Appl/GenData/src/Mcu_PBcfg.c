...
static CONST( Mcu_SIM_ClockConfigType, MCU_CONST) SIM_ClockConfigPB0_0 =
{
    ...
    (
        ...
        SIM_PLATGC_MPU_CLK_DISABLE_U32 |
...
static CONST(Mcu_SIM_ConfigType, MCU_CONST) SIM_ConfigPB0 =
{
    ...
    (
        SIM_CHIPCTL_DISABLE_ADC_SUPPLY_MON_U32 |
        SIM_CHIPCTL_ADC_SUPPLY_VDD_U32 |        
    ...
    (
        ...
        SIM_FTM0CLKSEL_TCLK0_PIN_U32 |        SIM_FTM3_FLT0_PIN_FLT0_U32 |
