...
FUNC(Std_ReturnType, RTE_CODE) Rte_Start(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  (void)SetRelAlarm(Rte_Al_TE_DLK_SWC_DLK_Runnable_100ms, RTE_MSEC_SystemTimer(0) + (TickType)1, RTE_MSEC_SystemTimer(100)); /* PRQA S 3417 */ /* MD_Rte_Os */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Stop(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  (void)CancelAlarm(Rte_Al_TE_DLK_SWC_DLK_Runnable_100ms); /* PRQA S 3417 */ /* MD_Rte_Os */
 ...
 *********************************************************************************************************************/
TASK(OsTask_CPUload) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
 ...
 *********************************************************************************************************************/
TASK(OsTask_DLK) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
