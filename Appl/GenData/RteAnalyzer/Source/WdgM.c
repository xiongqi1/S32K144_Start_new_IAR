 ...
 * Port Prototypes:
 * ================
 * alive_WdgMSupervisedEntity_LedTask
 *
 * general
 *
 * globalmode_Core0
 *
 * localStatus_WdgMSupervisedEntity_LedTask
 *
 * mode_WdgMSupervisedEntity_LedTask
 *
 *
 ...
 *   - triggered by server invocation for OperationPrototype <CheckpointReached> of PortPrototype <alive_WdgMSupervisedEntity_LedTask>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 ...
 *   - triggered by server invocation for OperationPrototype <GetLocalStatus> of PortPrototype <localStatus_WdgMSupervisedEntity_LedTask>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 ...
 *   Std_ReturnType Rte_Switch_mode_WdgMSupervisedEntity_LedTask_currentMode(WdgMMode mode)
 *   Modes of Rte_ModeType_WdgM_Mode:
 *   - RTE_MODE_WdgM_Mode_SUPERVISION_DEACTIVATED
 *   - RTE_MODE_WdgM_Mode_SUPERVISION_EXPIRED
 *   - RTE_MODE_WdgM_Mode_SUPERVISION_FAILED
 ...
 *********************************************************************************************************************/
  ...
  **********************************************************/
  ...
  {
    FncPtrType WdgM_FctPtr; /* PRQA S 3408 */ /* MD_Rte_TestCode */
    WdgM_FctPtr = (FncPtrType)Rte_Switch_mode_WdgMSupervisedEntity_LedTask_currentMode; /* PRQA S 0313 */ /* MD_Rte_TestCode */
  }
  fct_status = TSC_WdgM_Rte_Switch_mode_WdgMSupervisedEntity_LedTask_currentMode(RTE_MODE_WdgM_Mode_SUPERVISION_OK);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
