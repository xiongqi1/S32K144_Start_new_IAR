...
)
{
  ...
  Os_CoreSetCurrentStack(idleThread->Stack);                                                                            /* SBSW_OS_CORE_SETCURRENTSTACK_001 */
 ...
 */
#  pragma warning 557                                                                                                   /* PRQA S 3116 */ /* MD_MSR_1.1 */
# endif
/***********************************************************************************************************************
 *  Os_CoreIdle()
 **********************************************************************************************************************/
...
# if defined (OS_CFG_COMPILER_TASKING)                                                                                  /* COV_OS_COMPILERPRAGMA */
#  pragma warning restore                                                                                               /* PRQA S 3116 */ /* MD_MSR_1.1 */
# endif
...
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if(OS_LIKELY(Os_CoreAsrIsCoreLocal(targetAsrCore) != 0))                                                          /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* SBSW_OS_CORE_COREASRISCORELOCAL_001 */
      {
...
\ID COV_OS_COMPILERPRAGMA
   ...
   \REASON The condition is used to encapsulate a compiler specific pragma which simply supresses an compiler
           ...
           The affeceted compilers are fully tested on the according platform.
